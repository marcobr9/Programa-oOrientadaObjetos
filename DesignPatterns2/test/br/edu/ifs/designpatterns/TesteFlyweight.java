...
class TesteFlyweight {
	...
	void test() {
		...
		/*
		 * Todos os blocos devem implementar a interface Flyweight.
		 */
		assertInstanceOf(Flyweight.class, blocoPedra1);
		assertInstanceOf(Flyweight.class, blocoPedra2);
		assertInstanceOf(Flyweight.class, blocoPedra3);
		 ...
		 * Todos os blocos devem implementar a interface Flyweight.
		 */
		assertInstanceOf(Flyweight.class, blocoAr1);
		assertInstanceOf(Flyweight.class, blocoAr2);
		assertInstanceOf(Flyweight.class, blocoAr3);
		 ...
		 * Todos os blocos devem implementar a interface Flyweight.
		 */
		assertInstanceOf(Flyweight.class, areia1);
		assertInstanceOf(Flyweight.class, areia2);
		assertInstanceOf(Flyweight.class, areia3);
		 ...
		 * Todos os blocos devem implementar a interface Flyweight.
		 */
		assertInstanceOf(Flyweight.class, neve1);
		assertInstanceOf(Flyweight.class, neve2);
		assertInstanceOf(Flyweight.class, neve3);
