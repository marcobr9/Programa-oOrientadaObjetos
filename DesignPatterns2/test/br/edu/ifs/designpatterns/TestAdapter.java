...
import br.edu.ifs.designpatterns.adapter.impl.AdaptadorLista;
import br.edu.ifs.designpatterns.adapter.impl.AdaptadorString;
...
class TestAdapter {
	...
	void test() {
		...
		final String arquivo = "arquivos/alunos.txt";
		 ...
		 */
		assertEquals(repositorio.obterAlunos(), alunos);
